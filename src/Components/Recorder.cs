namespace Melanoplus.Components
{
    ...
    {
        public override Guid ComponentGuid => new("DC3311E5-261D-4E71-8D0D-04069E0FEABC");
        protected override Bitmap Icon => enable ?
                Properties.Resources.RecordON :
                Properties.Resources.RecordOFF;

        private readonly GH_Structure<IGH_Goo> dataTree = new();
    ...
    public class RecAttributes(IGH_Component component) : GH_ComponentAttributes(component)
    {
